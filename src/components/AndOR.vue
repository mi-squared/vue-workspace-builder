<template>
  <div class="and-or-template flex-lg-row" :class="isFirst ? 'and-or-first' : '' ">
    <div class="form-group and-or-top row">
      <div class="col-sm-1">
        <v-btn-toggle
            v-model="isAnd"
            mandatory
        >
          <v-btn @click.prevent="clickAnd">
            <v-icon>mdi-gate-and</v-icon>
          </v-btn>
          <v-btn @click.prevent="clickOr">
            <v-icon>mdi-gate-or</v-icon>
          </v-btn>
        </v-btn-toggle>
      </div>
      ...
      <div class="col">
        <div class="btn-group float-right" role="group" aria-label="Basic example">
          <button type="button" class="btn btn-xs add-rule" @click.prevent="addRule"> + add </button>
          <button type="button" class="btn btn-xs " @click.prevent="addGroup"> + ( group ) </button>
          <button type="button" v-if="!isFirst" class="btn btn-xs btn-purple" @click.prevent="deleteSelf()">
