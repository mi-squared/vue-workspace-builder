...
export default {
  ...
  methods: {
    init() {
      this.activeDatetime = this.activeModel[this.index]
      let initDateTime
      ...
      if (this.activeDatetime instanceof Date) {
        initDateTime = this.activeDatetime
      } else if (typeof this.activeDatetime === 'string' || this.activeDatetime instanceof String) {
        // see https://stackoverflow.com/a/9436948
        // KCC on init, use the default (mysql) date time format to parse
        initDateTime = parse(this.activeDatetime, this.defaultDateTimeFormat, new Date())
      }
    ...
    okHandler() {
      ...
      this.activeModel[this.index] = outputDatetime
      this.$emit('input', {
